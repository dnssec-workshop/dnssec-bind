...
RUN     apt-get install -y --no-install-recommends tcpdump traceroute curl wget git less screen vim nano ntp ntpdate telnet syslog-ng zip unzip man rsync ca-certificates lsof
